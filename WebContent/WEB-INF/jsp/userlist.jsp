...
<div class="right">
	...
	<div class="search">
		<form method="get"
			action="${pageContext.request.contextPath }/user/user">
			...
			<span>用户名：</span> <input name="queryname" class="input-text"
				...
				href="${pageContext.request.contextPath}/user/useradd">添加用户</a>
		</form>
	</div>
	<!--用户-->
	<table class="providerTable" cellpadding="0" cellspacing="0">
		...
		<c:set var="userList" value="${pagebean.pagelist}" />
			...
			<tr>
				...
				<td><span><a class="viewUser" href="javascript:;"
						userid=${user.id } username=${user.userName }><img
							src="${pageContext.request.contextPath }/resource/images/read.png"
...
<c:import url="rollpage.jsp">
	<c:param name="totalCount" value="${pagebean.infonum}" />
	<c:param name="currentPageNo" value="${pagebean.pageno}" />
	<c:param name="totalPageCount" value="${pagebean.pagetotal}" />
	<c:param name="queryname" value="${queryname }" />
	<c:param name="queryUserRole" value="${queryUserRole }" />
</c:import>
...
<div class="providerAdd" id="userViewDiv" style="display: none">
	<div>
		<label for="userName">用户名称：</label> <input type="text" name="userName"
			id="userName"> <font color="red"></font>
	</div>
	<div>
		<label>用户性别：</label> <input type="text"
	...
	<div>
		<label for="userRole">用户角色：</label> <input type="text"
			name="userRole" id="userRole" value="">
	</div>
</div>
</section>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/resource/js/userlist.js"></script>
