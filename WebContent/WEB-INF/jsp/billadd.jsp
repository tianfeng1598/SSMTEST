...
<div class="right">
     ...
     <div class="providerAdd">
         <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/resource/resource./bill.do">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/resource/resource/js/billadd.js"></script>