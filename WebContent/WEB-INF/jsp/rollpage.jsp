 		...
 		<div class="page-bar">
			<ul class="page-num-ul clearfix">
				...
				<c:if test="${param.currentPageNo < param.totalPageCount }">
					<a href="javascript:void(0);" onclick="page_nav(document.forms[0],${param.currentPageNo+1})">下一页</a>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/resource/js/rollpage.js"></script>
</html>